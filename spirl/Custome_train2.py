...
class ModelTrainer(BaseTrainer):
    def __init__(self, args,cid):
        ...
        self.data_dir =os.path.join(self._hp.data_dir, 'FL_{}'.format(cid))
        ...
        self.scheduler = torch.optim.lr_scheduler.CyclicLR(self.optimizer, base_lr=0.0000005, step_size_up=5, max_lr=self._hp.lr, gamma=0.5, mode='exp_range',cycle_momentum=False)
