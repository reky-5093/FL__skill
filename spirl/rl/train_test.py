...
class RLTrainer:
    ...
    def get_config(self):
        ...
        conf.agent.ll_agent_params.policy_params.policy_model_checkpoint = os.path.join(os.environ["EXP_DIR"],
                                         "skill_prior_learning/kitchen/12_client_1",str(self.cnt))
...
if __name__ == '__main__':
    ...
    for i in range(10):
        cnt = 10 * (i + 1)
        config.prefix = "FL_1_{}".format(cnt)
        RLTrainer(args=config, cnt = cnt)
        break
